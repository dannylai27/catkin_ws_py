...
def talker():
    ...
    r = rospy.Rate(200)  # Hz
    amp = 200.0  # 400/500/600/800
    T_frq = 8.0  # 8/10/12/16
    ...
    while not rospy.is_shutdown():
        ...
        i = 0
        while ros_time < 5 * T_frq * frq_const:
            if i == 0:
                ros_time = 0
                ...
                robot_movement_array.data[0] = -amp * exp(-time_const * ros_time) * (
                ...
                rospy.loginfo(rospy.get_caller_id() + "  velocity value: %s;  rostime: %s, i = %s",
                              robot_movement_array.data[2],
                              ros_time,
                              i)
                print("here I am", robot_movement_array.data[2])
