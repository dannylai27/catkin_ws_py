...
def callback(camera_pos, desired_pos, joint_1):
...
def error_computation():
    ...
    ts = message_filters.ApproximateTimeSynchronizer([dp_sub, dc_sub, j1_sub], 1, 0.15, allow_headerless=True) # 100 è lo slope, massimo delta t tra i tempi di arrivo (in secondi) consentito per accoppiare 2 messaggi, setroppo stretto ed i messaggi dai 2 topic arrivano sempre ad un delta t maggiore di quello indicato non verrà mai sottoscritto nulla ed i valori pubblicati saranno sempre quelli di inizializzazione 0 0 0 0 0 0
