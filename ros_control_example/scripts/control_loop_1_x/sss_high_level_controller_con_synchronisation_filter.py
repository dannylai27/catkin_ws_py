...
cam_x = 0
cam_y = 0 
pos_in_x = 320 # desired target x in image plane, x goes from 0 (left side) to 639 (right side) so 640 pixels  
pos_in_y = 240 # desired target y in image plane, y goes from 0 (up side) to 479 (bottom side) so 480 pixels
error_x = 0
error_y = 0
q_1 = 0
q_2 = 0
